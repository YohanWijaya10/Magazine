	...
	_thumbPreview.
		...
		function setPreview(view) {
			...
			if (view <= 28) {
				...
				// Handle pages beyond 28 (modify as needed)
				// Set a different background image or adjust the positioning for pages beyond 28
				preview.css({
					backgroundImage: 'url(other-preview.jpg)', // Set a different image
					backgroundPosition: '0px 0px' // Adjust the position accordingly
				});
			}
		}
